...
export const metadata = {
    title: "Tesseract",
    description: "Tesseract - AI Autopilot for Finance",
    icons: {
        icon: "./favicon.ico",
    },
};
    ...
    return (
        <html lang="en">
            <head>
                ...
                />
                <meta name="product-name" content="Tesseract - AI Autopilot for Finance" />
                {/* Twitter Card data */}
                <meta name="twitter:card" content="summary" />
                <meta name="twitter:site" content="@ui8" />
                <meta name="twitter:title" content="Tesseract - AI Autopilot for Finance" />
                <meta
                ...
                <meta property="og:title" content="Tesseract - AI Autopilot for Finance" />
                ...
                <meta
                    ...
                    content="Figma UI kit designed to enhance the functionality of ChatGPT"
                />
                <meta property="og:site_name" content="Tesseract - AI Autopilot for Finance" />
